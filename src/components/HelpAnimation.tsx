...
const HelpAnimation = () => {
  const animateHead = {
    ...
    animate: {rotate: 50, x: 60},
  }
  const animateLeftArm = {
    initial: {rotate: 0, x: 0}, 
    animate: {rotate: 110, x: 12},
  }
            ...
            <g id="mascot-container">
              <g id="tail-container">
                ...
                <g id="pie-chart">
                  <path 
                    id="pie-chart-slice" 
                    d="M236.09 344.94C223.91 344.94 213.51 352.54 209.37 363.26L236.09 373.59V344.94Z" 
                    fill="#5FD9C5"
                  />
                  <path 
                    id="pie-chart-main" 
